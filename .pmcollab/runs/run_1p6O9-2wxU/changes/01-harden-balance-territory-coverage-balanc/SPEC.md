# Change Specification: Harden test surface — Balance Territory Coverage (balance-territory-coverage#1)
...
| Field | Value |
|-------|-------|
| Title | Harden test surface — Balance Territory Coverage (balance-territory-coverage#1) |
