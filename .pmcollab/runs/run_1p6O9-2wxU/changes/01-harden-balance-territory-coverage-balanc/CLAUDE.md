# Balance Territory Coverage — harden test surface (balance-territory-coverage#1)

## Project Overview

Balance Territory Coverage — harden test surface (balance-territory-coverage#1) — see SPEC.md for full project requirements.
